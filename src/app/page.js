    ...
    <div className={`modal-overlay${closing?' closing':''}`} onClick={handleOverlay} style={{padding:'clamp(10px,4vw,20px)'}}>
      <div className={`modal-card${closing?' closing':''}`} style={{maxWidth:'min(500px,100%)'}}>
        ...
        <div className="modal-inner" style={{padding:'clamp(24px,5vw,38px) clamp(18px,5vw,32px) clamp(18px,4vw,26px)'}}>
          <p className="modal-eyebrow">✦ Ecos de Amor ✦</p>
    ...
    <>
      <style>{`
        .book-scene {
          ...
          min-height:460px; padding:clamp(20px,5vw,56px) 8px;
        }
        .book-closed-wrap {
        ...
        .b-spread {
          ...
          overflow:hidden; min-height:clamp(340px,52vw,460px);
        ...
        .b-nbleft {
          ...
          padding:clamp(10px,2vw,16px); border-radius:0 0 0 4px;
        }
        .b-nbright {
        ...
        .b-arrow:hover:not(:disabled) {
          background:rgba(201,169,110,0.07);
          border-color:rgba(201,169,110,0.45); color:#c9a96e;
        }
        .b-arrow:disabled { opacity:0.18; cursor:default; }
        .b-counter {
          font-family:'Lora',Georgia,serif; font-style:italic;
          font-size:12px; color:rgba(201,169,110,0.38); flex:1; text-align:center;
        }
        .b-closebtn {
          background:none; border:none; color:rgba(255,255,255,0.2);
          font-size:10px; letter-spacing:2px; font-family:Montserrat,sans-serif;
          cursor:pointer; transition:color 0.2s; padding:4px; text-transform:uppercase;
        }
        ...
        {isOpen && (
          <div className="book-open-wrap">
            <div className="b-spread">
              ...
              <div className={`b-right${flipping?` flip-${flipDir}`:''}`}>
                ...
                {currentPoem ? (
                  <>
                    ...
                    <div className="b-pdiv">
                      <div className="b-pdivline"/>
                      <span className="b-pheart">♥</span>
                      <div className="b-pdivline"/>
                    </div>
  ...
  return (
    <>
      ...
      <nav className="luxury-nav" style={{gap:8}}>
        <button onClick={goHome} className="nav-logo" style={{
          fontSize:'clamp(13px,3vw,20px)',
          display:'flex',alignItems:'center',gap:8,
        }}>
          <img src="/Icono.png" alt="" style={{
            width:'clamp(20px,3.5vw,28px)',height:'clamp(20px,3.5vw,28px)',
            objectFit:'contain',borderRadius:6,opacity:0.9,flexShrink:0,
          }}/>
          Ecos de Amor
        </button>
